 ...
 * 
 */
@WebServiceClient(name = "MySourceService", targetNamespace = "http://soap/", wsdlLocation = "http://localhost:1010/source?wsdl")
    ...
    extends Service
{
    ...
    private final static QName MYSOURCESERVICE_QNAME = new QName("http://soap/", "MySourceService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:1010/source?wsdl");
    ...
    public MySource getMySourcePort() {
        return super.getPort(new QName("http://soap/", "MySourcePort"), MySource.class);
    }
    ...
    public MySource getMySourcePort(WebServiceFeature... features) {
        return super.getPort(new QName("http://soap/", "MySourcePort"), MySource.class, features);
    }
