...
<div class="container">
    <div class="row justify-content-center" style="height: 100vh">
        ...
        <%}%>
        <form action="withdraw" method="post" class="col-lg-4 col-md-8 col-12 p-5 rounded-5 shadow-lg align-self-center">
            ...
            <div class="form-group">
                ...
                <input type="number" name="withdrawAmount" placeholder="Amount" class="form-control" required />
            </div>
