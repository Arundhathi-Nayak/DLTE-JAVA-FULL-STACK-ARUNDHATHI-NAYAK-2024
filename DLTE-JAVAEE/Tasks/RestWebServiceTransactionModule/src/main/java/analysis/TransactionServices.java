...
//        public List<Transaction> getTransactions(@RequestParam(required = false) Integer minimum, @RequestParam(required = false) Integer maximum) {
//            if (minimum != null && maximum != null) {
//                return transactions.stream()
//                        .filter(t -> t.getTransactionAmount() > minimum && t.getTransactionAmount() < maximum)
//                        .collect(Collectors.toList());
//            } else {
//                return transactions;
//            }
