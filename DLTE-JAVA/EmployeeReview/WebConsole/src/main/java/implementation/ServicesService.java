 ...
 * 
 */
@WebServiceClient(name = "ServicesService", targetNamespace = "http://implementation/", wsdlLocation = "http://localhost:1011/webService?wsdl")
    ...
    extends Service
{
    ...
    private final static QName SERVICESSERVICE_QNAME = new QName("http://implementation/", "ServicesService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:1011/webService?wsdl");
    ...
    public Services getServicesPort() {
        return super.getPort(new QName("http://implementation/", "ServicesPort"), Services.class);
    }
    ...
    public Services getServicesPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://implementation/", "ServicesPort"), Services.class, features);
    }
