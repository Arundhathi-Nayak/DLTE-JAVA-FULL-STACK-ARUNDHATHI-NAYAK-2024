 ...
 * 
 */
@WebServiceClient(name = "ServicesService", targetNamespace = "http://implementation/", wsdlLocation = "http://localhost:1010/webService?wsdl")
    ...
    extends Service
{
    ...
    static {
        ...
        try {
            url = new URL("http://localhost:1010/webService?wsdl");
